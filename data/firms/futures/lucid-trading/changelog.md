...
# Lucid Trading — Changelog

A history of notable changes to Lucid Trading's account structure, rules, and operations. Most recent changes first.

## 2026 (approximate) — LucidFlex consistency rule and 100% first-$10K payout introduced
...
## 2025 (approximate) — LucidDirect instant-funded product launched

Lucid Trading added the LucidDirect product line, providing instant funded account access without an evaluation phase. LucidDirect accounts carry a 20% consistency rule on the funded account and no evaluation fee equivalent. The firm also expanded platform support to include both Rithmic and Tradovate.
